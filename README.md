...
3. Develop your app in *my_app* folder. This is your main package. You can create subpackages/ folders. Dont forget to include a ```__init__.py``` file for each subpackage. 
